                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                    	&nbsp;&nbsp;
                                    	<c:forEach var="cd" items="${curdep}">
                                    	${cd.upperdepartmentname}(部门编号:${cd.upperdepartmentid})
                                    	</c:forEach>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <c:forEach var="cd" items="${curdep}">
                                      	<c:choose>
                                        	<c:when test="${cd.mark==1}"> 活动 </c:when>
                                        	<c:when test="${cd.mark==2}"> 撤销 </c:when>     
                                        </c:choose>  
                                        </c:forEach>
                                    </td>
                                    <td></td>
			...
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<table class="table table-bordered table-striped">
						...
						<tbody>
						<c:forEach var="eid" items="${empindep}">
							<tr>
								<td>${eid.staffid}</td>
								<td>${eid.staffname}</td>
								<td>${eid.positionname}/${eid.positionlevel}级</td>
								<td>${eid.sex}</td>
                                <td>${eid.age}</td>
							</tr>
						</c:forEach>
