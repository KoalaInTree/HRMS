								...
								<div class="widget-content nopadding">
									<form id="eform" class="form-horizontal" method="post" />
	                                    <div id="info1" class="control-group">
	                                        ...
	                                        <div class="controls">
	                                         <input id="pkey" name="pkey" type="hidden" value="${pkey}">
	                                            <input type="text" name="jname" id="jname" value="${typename}" />
	                                        </div>
	                                    </div>
									...
									<script type="text/javascript">
											$("#btn_submit").click(function(){
												var pkey= $("#pkey").val();
												var jname = $("#jname").val();	//假期名称
												
												$.ajax({
													type:"POST",
													url:"/HRMS/VModify.action",
													data:{"pkey": pkey,"jname":jname},
													dataType:"json",
													error:function (){
