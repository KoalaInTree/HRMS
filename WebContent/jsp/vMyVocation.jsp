...
<html>
	<head>
		...
		<script src="/HRMS/js/jquery.min.js"></script>
       	...
       	<script src="/HRMS//HRMS/js/jquery-1.11.2.min.js" type="text/javascript"></script>
	...
	<body>
            ...
            <ul>
                ...
                <li class="submenu">
                   ...
                   <ul>
                        ...
                        <li class="active"><a href="/HRMS/ulist.action">查看休假记录</a></li>
		...
		<div id="content">
			...
			<form id="f1" action="/HRMS/ulist.action" method="post" name="searchForm">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="control-group">
						<span class="span6">
							休假时间：
                            <input id="startDate" name="startDate" type="date" style="width:35%" value="${svo.startDate}"/>
                            -
                            <input id="endDate" name="endDate" type="date" style="width:35%" value="${svo.endDate}"/>
						</span>
                        <span class="span3">
