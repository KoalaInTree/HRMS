	...
	<body>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="/HRMS/jsp/deptlist.jsp">部门列表</a>
...
<script type="text/javascript">
		$("#btn_submit").click(function(){
			...
			var userid = $("#userid").val();	//负责人编号
			var dno = $("#dno").val();
			var uplevel = $("#uplevel").val();
			
				$.ajax({
					type:"POST",
					url:"/HRMS/addDept.action",
					data:{"dname": dname,"userid":userid,"dno":dno,"uplevel":uplevel},
					dataType:"json",
					error:function (){
