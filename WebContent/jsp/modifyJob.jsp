								...
								<div class="widget-content nopadding">
									<form id="eform" class="form-horizontal" method="post" />
	                                    <div id="info1" class="control-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="text" name="jname" id="jname" value="${posname}" />
	                                            <input type="hidden" id="mark" value="${pid}">
	                                        </div>
	                                    </div>
	                                    <div id="info2" class="control-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="number" name="jlevel" id="jlevel" value="${mark}" />
	                                        </div>
	                                    </div>
...
<script type="text/javascript">
		$("#coco_submit").click(function(){
			var jname = $("#jname").val();	//部门名称
			var userid = $("#mark").val();	//负责人编号
			var jlevel = $("#jlevel").val();
			
			
				$.ajax({
					type:"POST",
					url:"/HRMS/updateposi.action",
					data:{"jname": jname,"pid":userid,"jlevel":jlevel},
					dataType:"json",
					error:function (){
